namespace :sample do
  ...
  task demo: :environment do
    ...
    Product.create!([
       ...
       { id: 5, name: "Medium MySQL", description: "Medium MySQL", active: true, img: "products/aws_rds.png", deleted_at: nil, product_type: "", setup_price: "1.99", hourly_price: "0.004", monthly_price: "0.1" },
