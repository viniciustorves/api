namespace :sample do
  ...
  task demo: :environment do
    ...
    Product.create!([
       ...
       { id: 34, name: "MS Exchange Server", description: "MS Exchange Server", active: true, img: "products/exchange.png", deleted_at: nil, product_type: "Platforms", setup_price: "0.0", hourly_price: "3.5", monthly_price: "5.0" },
    ...
    Project.create!([
       ...
       { id: 3, name: "Blog", description: "Project description", cc: "--CC--", budget: 12405.09, staff_id: "--STAFF_ID--", start_date: "2015-02-06", end_date: "2015-11-06", img: "images/128x128-wordpress.png", deleted_at: nil, spent: 4135.03, status: 0, approval: 1},
       { id: 4, name: "Cloud File Share", description: "Project description", cc: "--CC--", budget: 25000.0, staff_id: "--STAFF_ID--", start_date: "2015-02-06", end_date: "2015-11-06", img: "images//cloud-checkmark-128.png", deleted_at: nil, spent: 0.0, status: 0, approval: 1},
    ...
    OrderItem.create!([
        ...
        { id: 20, order_id: 8, cloud_id: 1, :product => Product.where(id: 18).first, service_id: nil, provision_status: nil, deleted_at: nil, :project => Project.where(id: 3).first, miq_id: nil, uuid: "44642c1d-2fb9-41d8-9acf-d57e87da61fd", setup_price: "0.0", hourly_price: "2.0", monthly_price: "0.0", payload_request: nil, payload_acknowledgement: nil, payload_response: nil, latest_alert_id: nil},
        { id: 21, order_id: 9, cloud_id: 2, :product => Product.where(id: 34).first, service_id: nil, provision_status: nil, deleted_at: nil, :project => Project.where(id: 3).first, miq_id: nil, uuid: "add8e14e-6ac2-4476-a9f5-84c6b351a716", setup_price: "0.0", hourly_price: "3.5", monthly_price: "0.0", payload_request: nil, payload_acknowledgement: nil, payload_response: nil, latest_alert_id: nil}
    ...
    Alert.create!([
       ...
       { id: 1, project_id: 3, staff_id: 0, order_item_id: 6, status: "CRITICAL", message: "Blog has 2 months of funding remaining, please increase funding.", start_date: nil, end_date: nil}
    ])
